...
- Name: hestia.spec.js >> usuario puede agregar un gasto y verlo reflejado
- Location: tests\e2e\hestia.spec.js:11:5
...
Call log:
  - waiting for locator('[placeholder*="descripción" i]')
